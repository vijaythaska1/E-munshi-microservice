...
let a = (e, o, a, n)=>{
    ...
    if (console.log(o, a), !(R instanceof r)) {
        let o = R.statusCode || R instanceof t.Error ? s.BAD_REQUEST : s.INTERNAL_SERVER_ERROR, a = R.message || s[o];
        R = new r(o, a, !1, e.stack);
    }
    n(R);
}, n = (r, t)=>{
    let { statusCode: a, message: n } = r;
    "production" !== e.env || r.isOperational || (a = s.INTERNAL_SERVER_ERROR, n = s[s.INTERNAL_SERVER_ERROR]), t.locals.errorMessage = r.message;
    let R = {
        code: a,
        message: n,
        ..."development" === e.env && {
