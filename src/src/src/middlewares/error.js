...
let n = (e, o, n, a)=>{
    ...
    if (console.log(o, n), !(R instanceof r)) {
        let o = R.statusCode || R instanceof t.Error ? s.BAD_REQUEST : s.INTERNAL_SERVER_ERROR, n = R.message || s[o];
        R = new r(o, n, !1, e.stack);
    }
    a(R);
}, a = (r, t)=>{
    let { statusCode: n, message: a } = r;
    "production" !== e.env || r.isOperational || (n = s.INTERNAL_SERVER_ERROR, a = s[s.INTERNAL_SERVER_ERROR]), t.locals.errorMessage = r.message;
    let R = {
        code: n,
        message: a,
        ..."development" === e.env && {
