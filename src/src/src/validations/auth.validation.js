...
let { password: r } = require("./custom.validation"), s = {
    body: e.object().keys({
...
export { s as register, i as login, o as logout, t as refreshTokens, d as forgotPassword, a as resetPassword, n as verifyEmail };
