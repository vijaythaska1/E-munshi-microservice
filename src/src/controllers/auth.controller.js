...
import { generateAuthTokens as r, removeToken as i } from "../services/token.service";
let c = e(async (e, a)=>{
    let i = await t(e.body), c = await r(i);
    a.status(s.OK).send({
    ...
    let { email: i, password: c } = e.body, o = await a(i);
